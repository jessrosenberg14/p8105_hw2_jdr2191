...
The snp dataset contained the year and month of the observation as well as a variable indicating the closing values of the S&P stock index on the associated date. The dates in this dataset ranged from `r min(pull(snp_df, year))` to `r max(pull(snp_df, year))`.
